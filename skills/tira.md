---
description: Create or read Jira tickets using the tira CLI. Use when the user wants to create a Jira issue/ticket/story/task/bug, look up a ticket by key (e.g. PROJ-123), or mentions "tira".
name: tira
---
...
tira get <KEY> --edit   # open in $EDITOR and write changes back
```
